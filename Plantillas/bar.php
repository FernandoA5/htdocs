      ...
      if(!controlSesion::sesionIniciada())
      {
        ...
        <li class="dopdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li ><a href="<?php echo MYBLOG; ?>"><span class="glyphicon glyphicon-user" style="color:white"></span><?php echo " " . $_SESSION["nombre_usuario"] ?></a></li>
            <li><a href="<?php echo LOGOUT; ?>"><span class="glyphicon glyphicon-off" style="color:white"> </span>  Cerrar Sessión</a></li>
